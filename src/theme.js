...
export const FOREST_THEME = {
  ...
  dark: false,
  label: "Forest",
  title: "Forest Trail Log",
  eyebrow: "50-HOUR FOREST TRAIL",
  exportPrefix: "forest-trail-log",
  ...
  accent: "#4F7A5B",
  accentDark: "#365740",
  accentBg: "rgba(79,122,91,0.13)",
  onAccent: "#FFFFFF",
  night: "#4B5C7A",
  nightBg: "rgba(75,92,122,0.14)",
  rust: "#9C6B44",
  onRust: "#FFFFFF",
  gold: "#D9A441",
  goldBg: "rgba(217,164,65,0.18)",
  divider: "#E1DCC7",
  locked: "#EAE6D6",
  ...
  radius: "20px",
  radiusSm: "14px",
  shadow: "0 1px 2px rgba(51,64,47,0.05), 0 10px 22px -10px rgba(51,64,47,0.16)",
  dividerStyle: "dots",
  displayWeight: 600,
  displayLetterSpacing: "0",
  displayStyle: "normal",
  ...
  copy: {
    whoRiding: "Who's your fellow traveler?",
    startSession: "Begin the trail",
    endSession: "End the trail",
    totalHoursLabel: "Hours on the trail",
    nightHoursLabel: "Hours under moonlight",
    dayHoursLabel: "Hours in daylight",
  },
};

export const ALL_THEMES = [MOM_THEME, DAD_THEME, NEON_THEME, KAWAII_THEME, RETRO_THEME, FOREST_THEME];
