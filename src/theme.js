...
export const FOREST_THEME = {
  ...
  accent: "#5E8C5A",
  accentDark: "#3E6140",
  accentBg: "rgba(94,140,90,0.20)",
  onAccent: "#F7F3E4",
  night: "#495B85",
  nightBg: "rgba(73,91,133,0.22)",
  rust: "#A8542F",
  onRust: "#F7F3E4",
  gold: "#E3A73C",
  goldBg: "rgba(227,167,60,0.22)",
  divider: "#3A4A34",
  locked: "#233229",
  ...
  radius: "28px",
  radiusSm: "18px",
  shadow: "0 1px 2px rgba(10,16,10,0.4), 0 16px 34px -14px rgba(94,140,90,0.5)",
  dividerStyle: "chain",
  displayWeight: 600,
  displayLetterSpacing: "0",
  displayStyle: "italic",
