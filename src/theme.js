...
export const OFFROAD_THEME = {
  key: "offroad",
  dark: false,
  label: "Off-Road",
  title: "Off-Road Log",
  eyebrow: "50 HOURS OFF THE PAVEMENT",
  exportPrefix: "off-road-log",
  ...
  accent: "#D9541A",
  accentDark: "#A8400F",
  accentBg: "rgba(217,84,26,0.16)",
  onAccent: "#FBF8EE",
  night: "#46586B",
  nightBg: "rgba(70,88,107,0.18)",
  rust: "#8B3A22",
  onRust: "#FBF8EE",
  gold: "#C9A227",
  goldBg: "rgba(201,162,39,0.20)",
  divider: "#B8AE8E",
  locked: "#EBE4CC",
  ...
  radius: "10px",
  radiusSm: "8px",
  shadow: "0 2px 4px rgba(42,38,32,0.15), 0 12px 24px -10px rgba(42,38,32,0.28)",
  dividerStyle: "chain",
  displayWeight: 400,
  displayLetterSpacing: "0.03em",
  displayStyle: "normal",
  ...
  copy: {
    whoRiding: "Who's riding shotgun?",
    startSession: "Engage 4WD",
    endSession: "Park it",
    totalHoursLabel: "Hours off-road",
    nightHoursLabel: "After-dark hours",
    dayHoursLabel: "Daylight hours",
  },
};

export const ALL_THEMES = [MOM_THEME, DAD_THEME, NEON_THEME, KAWAII_THEME, RETRO_THEME, OFFROAD_THEME];
